<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url('Admin/indexAdmin'); ?>" class="brand-link">
        <img src="<?= base_url(); ?>assetsApp/dist/img/AdminLTELogo.png" alt="Admin" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('Admin/Supplier') ?>" class="nav-link <?= $this->uri->segment(2) == "Supplier" ? 'active' : ''; ?>">
